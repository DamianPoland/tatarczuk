        ...
        <section className={style.background}>
            <div className={style.privacyContainer}>
                ...
                <div>
                    ...
                    <ol>
                        <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>tatarczuk.com.pl</b></li>
                        <li>Operatorem serwisu oraz Administratorem danych osobowych jest: Zakład Instalacyjny Wod. Kan. CO i Gaz Paweł Tatarczuk ul. Wielunska 38, 81-502 Gdynia NIP: 5860200178</li>

                        <li>Adres kontaktowy poczty elektronicznej operatora: tatarczuk.serwis@poczta.fm</li>
